# DocuMind 文档智能处理系统 - 安装与使用指南

## 一、项目概述

DocuMind 是一个基于 Spring Cloud 的企业级文档智能处理系统，包含用户管理、文件存储、AI 分析、文档管理、智能 Agent 等功能模块，采用 Docker Swarm 集群部署。
...
| 服务名称 | 访问地址 | 默认账号密码 |
|--------|--------|-----------|
| Nacos 控制台 | http://your-manager-ip:8848/nacos | your-nacos-username/your-nacos-password |
| API 网关 | http://your-manager-ip:8080 | - |
| 用户服务 Swagger | http://your-manager-ip:8081/swagger-ui.html | - |
| 文件服务 Swagger | http://your-manager-ip:8082/swagger-ui.html | - |
| AI 服务 Swagger | http://your-manager-ip:8083/swagger-ui.html | - |
| 文档服务 Swagger | http://your-manager-ip:8084/swagger-ui.html | - |
| MinIO 控制台 | http://your-manager-ip:9001 | your-minio-username/your-minio-password |
| RabbitMQ 控制台 | http://your-manager-ip:15672 | your-rabbitmq-username/your-rabbitmq-password |
| Grafana 监控 | http://your-manager-ip:3000 | your-grafana-username/your-grafana-password |

### 4.1 系统测试账号

- **管理员**：your-admin-username / your-admin-password
- **普通用户**：your-user-username / your-user-password
