...
public class UserController {
    ...
    public Result<UserVO> register(@RequestBody RegisterDTO registerDTO) {
        ...
        log.info("发送用户注册消息到 RabbitMQ");
        rabbitMQUtil.send(RabbitMQConfig.USER_EXCHANGE, RabbitMQConfig.USER_REGISTER_ROUTING_KEY, registerMessage);
    ...
    private void sendUserOperateLog(Long userId, String operation, String description) {
        ...
        log.info("发送用户操作日志消息到 RabbitMQ");
        rabbitMQUtil.send(RabbitMQConfig.USER_EXCHANGE, RabbitMQConfig.USER_OPERATE_LOG_ROUTING_KEY, message);
    }
