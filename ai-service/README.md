...
AI 服务模块是 DocuMind 项目的核心智能处理模块，基于 Spring AI 框架实现，提供文档智能分析、处理和协作功能。该模块负责对接外部 AI 服务，实现文档摘要、纠错、关键词提取等功能，并扩展支持 AI Agent 架构，包括 RAG 知识库系统、对话功能和 AIOps 功能。
...
| RABBITMQ_USERNAME | RabbitMQ 用户名 | your_rabbitmq_username |
