...
echo "| 用户服务 Swagger   | http://${MANAGER_IP}:8081/swagger-ui.html   |"
echo "| 文件服务 Swagger   | http://${MANAGER_IP}:8082/swagger-ui.html   |"
echo "| AI 服务 Swagger    | http://${MANAGER_IP}:8083/swagger-ui.html   |"
echo "| 文档服务 Swagger   | http://${MANAGER_IP}:8084/swagger-ui.html   |"
